...
SECRET_KEY = 'django-insecure-a!=7zw82e$+zdp!!-x-9(21+lrb95u&x%8*256%fev4isuoz&_'
...
# Adicione no bloco REST_FRAMEWORK (se não existir, crie):
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',
    ),
    # Por padrão, vamos deixar AllowAny para não quebrar o App do Cidadão,
    # e bloquearemos manualmente as views do Admin.
